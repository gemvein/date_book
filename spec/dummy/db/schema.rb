...
ActiveRecord::Schema.define(version: 20_170_808_150_920) do
  ...
  create_table 'event_occurrences', force: :cascade do |t|
    ...
    t.datetime 'end_date'
    t.index %w[schedulable_type schedulable_id], name: 'index_event_occurrences_on_schedulable_type_and_schedulable_id'
  end
  ...
  create_table 'schedules', force: :cascade do |t|
    ...
    t.index %w[schedulable_type schedulable_id], name: 'index_schedules_on_schedulable_type_and_schedulable_id'
  end
